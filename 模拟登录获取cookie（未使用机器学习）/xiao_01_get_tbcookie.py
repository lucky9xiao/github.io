...
class Taobao():
    ...
    def log_in(self):
        ...
        while True:
            ...
            # 鼠标移动点击，切换成账号密码登录（默认打开是快速登录界面，若不是，此段注释掉）
            ...
            try:
                ...
                print(e)
                self.driver.save_screenshot("tbfailture.jpg")
                continue
        # 打印快照
        self.driver.save_screenshot("successful.jpg")
        # 输出登陆之后的cookies
